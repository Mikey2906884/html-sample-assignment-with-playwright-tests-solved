...
In this exercise you will learn to operate with assignments of the HTML&CSS
curriculum.
...
- [x] All the tests MUST pass. Fix the errors in case any tests don't pass
      BEFORE you submit (acceptance criteria)
...
- [x] Add a paragraph of text (20 words at least). You can use random text for
